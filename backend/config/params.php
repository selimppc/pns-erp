...
return [
    ...
    'employer_create' => '<b>New Employer :</b> In this screen, all of the required fields need to be filled before clicking the button <b>“Save”.</b> Fields marked with (*) are mandatory. You can go back to your homescreen to view customer information(s) by clicking the menu tab <b>“Manage Employers.</b>',
    ...
    'inventory_delivery_order' => '<b>Delivery Order:</b> In this screen you will be able to confirm delivery by clicking on the button <b>"Confirm"</b> under the <b>Confirm Delivery</b> column. To view report in pdf or xls click on icon button of <b>"PDF"</b> or <b>"XLS"</b>. You can also view the details, click on the link under the <b>"Sales Number"</b> column',

    'manage_recipt_index' => '<b>Money Receipt:</b> This screen will allow you to view customer(s) invoice receivable history. For money receipt, click on the link under <b>"Customer Code"</b> column. The link will redirect you to a new entry screen for the <b>Money Receipt</b>. To view the details for customer click on the button under the <b>View Money Receipt Column</b>. To Cancel or Confirm go to the manage screen by clicking on the menu tab <b>"Manage Money Receipt"</b>',

    'create_money_receipt' => '<b>Money Receipt:</b> Fill in the <b>"Money Receipt"</b> as required. On your right hand side there are two separate tables. On the <b>"Unpaid Invoice List"</b> click under the <b>"Invoice No"</b> row for generating <b>Allocated Invoice</b> which will appear on the table <b>"Allocated Invoice"</b>. Click on <b>Save</b> button.<br/><b><span style="color:green;">Note: Payment can be Part or Full. </span><b/><br/><b><span style="color:red;">Warning: "Allocated Invoice" and "Payment Voucher" currency must remain the same</span></b>'
];
