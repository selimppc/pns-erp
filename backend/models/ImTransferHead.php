...
class ImTransferHead extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'note' => Yii::t('app', 'Note'),
            'from_branch_id' => Yii::t('app', 'From Branch ID'),
            'from_currency_id' => Yii::t('app', 'From Currency ID'),
            'from_exchange_rate' => Yii::t('app', 'From Exchange Rate'),
            'to_branch_id' => Yii::t('app', 'To Branch ID'),
            'to_currency_id' => Yii::t('app', 'To Currency ID'),
            'to_exchange_rate' => Yii::t('app', 'To Exchange Rate'),
