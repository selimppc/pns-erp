...
/* @var $model backend\models\PpPurchaseDetailSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="pp-purchase-detail-search">
    ...
    <?php // echo $form->field($model, 'uom_quantity') ?>

    <?php // echo $form->field($model, 'unit_quantity') ?>
