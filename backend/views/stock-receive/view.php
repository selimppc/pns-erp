...
$this->params['breadcrumbs'][] = ['label' => 'Stock Receive', 'url' => ['index']];
...
<div class="page-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<?= Url::toRoute(['/stock-receive']); ?>">Stock Receive</a></li>
    ...
    <div class="panel">
        ...
        <div class="panel-body">
            ...
            ?>
                ...
                <?= $model->status == 'dispatch'?Html::a(Yii::t('app', 'Receive'), ['confirm-receive', 'id' => $model->id], ['class' => 'btn btn-xs btn-success',"data-pjax" => 0, 'onClick' => 'return confirm("Are you sure you want to receive this item?") ']):''; ?>
